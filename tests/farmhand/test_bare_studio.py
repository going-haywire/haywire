...
haybale-studio installed serving exactly the nine studio_* tools. That exact-set
...
IS true and testable here: the nine studio_* baseline tools are always present.
...
def test_studio_baseline_always_served(farmhand_bare_server):
    ...
    # Every studio_* tool present is one of the nine baseline tools.
