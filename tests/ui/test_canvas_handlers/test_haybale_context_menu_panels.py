...
def test_node_action_panel_editor_is_context_menu(panel_cls):
    assert panel_cls.class_identity.editor_key == "context_menu"
...
def test_node_action_panel_scope_is_node(panel_cls):
    assert "node" in panel_cls.class_identity.scope
...
def test_edge_action_panel_scope_is_edge(panel_cls):
    assert "edge" in panel_cls.class_identity.scope
...
def test_edge_errors_panel_editor_is_context_menu():
    assert EdgeErrorsPanel.class_identity.editor_key == "context_menu"


def test_edge_errors_panel_scope_is_edge():
    assert "edge" in EdgeErrorsPanel.class_identity.scope
...
def test_edge_warnings_panel_editor_is_context_menu():
    assert EdgeWarningsPanel.class_identity.editor_key == "context_menu"


def test_edge_warnings_panel_scope_is_edge():
    assert "edge" in EdgeWarningsPanel.class_identity.scope
...
def test_edge_connection_path_panel_editor_is_context_menu():
    assert EdgeConnectionPathPanel.class_identity.editor_key == "context_menu"


def test_edge_connection_path_panel_scope_is_edge():
    assert "edge" in EdgeConnectionPathPanel.class_identity.scope
...
def test_selection_action_panel_scope_is_selection(panel_cls):
    assert "selection" in panel_cls.class_identity.scope
