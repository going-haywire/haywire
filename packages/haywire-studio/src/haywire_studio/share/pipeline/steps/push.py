...
from haywire_studio.share.barn import current_ref
from haywire_studio.share.git import git_remote, git_remote_streaming
from haywire_studio.share.pipeline.errors import PipelineStateError, PushError
from haywire_studio.share.pipeline.results import PushResult
...
def current_branch(pipeline: "SharePipeline") -> str | None:
    ...
    Delegates to :func:`haywire_studio.share.barn.current_ref`. Unlike the
