...
``haywire_studio.share`` rather than the concrete submodule; narrowing that
...
from haywire_studio.share import git
...
from haywire_studio.share.readme import _update_readme_markers
