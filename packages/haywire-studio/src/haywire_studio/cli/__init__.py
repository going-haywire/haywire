...
on the parsed namespace, so adding a sixth subcommand means adding one
...
from haywire_studio.cli import deps, docs, init, rename, share
...
SUBCOMMANDS: Sequence[_SubcommandModule] = (init, share, rename, deps, docs)
