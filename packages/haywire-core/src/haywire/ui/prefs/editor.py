...
class EditorSettings(Bag):
    ...
    auto_save_interval_seconds: int = prop(
        60,
    ...
    multi_select_modifier: str = prop(
        "ctrl",
    ...
    # Clipboard
    copy_with_connections: bool = prop(
        True,
