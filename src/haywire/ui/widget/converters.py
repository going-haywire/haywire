...
class FormattingConverter(BindingConverter):
    ...
    def __init__(self, 
                 format_spec: str | Callable[[Any], str],
...
class ExtractorConverter(BindingConverter):
    ...
    def __init__(self,
                 ...
                 updater: Optional[Callable[[Any, Any], None]] = None):
        """
        Args:
...
class Converters:
    ...
    @staticmethod
    def format(format_spec: str | Callable, 
              extractor: Optional[Callable] = None) -> FormattingConverter:
        """Create formatting converter"""
        return FormattingConverter(format_spec, extractor)
    
    @staticmethod
    def range(min_value: Optional[float] = None,
             max_value: Optional[float] = None,
             clamp: bool = True) -> RangeValidatingConverter:
    ...
    @staticmethod
    def extractor(extractor: Callable,
                 updater: Optional[Callable] = None) -> ExtractorConverter:
