...
The runtime that backs the Library Browser's Refresh / Add Source / Edit File flow. Spec: [`internals/specs/marketstall-distribution.md`](../../internals/specs/marketstall-distribution.md). Code: `haywire.core.marketstall`.
