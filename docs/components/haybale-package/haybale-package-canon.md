...
`marketstall.toml` lives at the repo root, not inside the haybale package directory — see [`internals/specs/marketstall-distribution.md`](../../../internals/specs/marketstall-distribution.md) §2.
