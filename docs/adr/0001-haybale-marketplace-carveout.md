---
name: haybale-marketplace-carveout
description: Library install/uninstall/enable/disable orchestrator and its editors move out of haywire-studio/haybale-studio into an optional haybale-marketplace library
status: accepted
level: architectural
---
