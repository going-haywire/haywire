...
1. `docs/documentation/settings.md/01-overview.md` — architecture overview: three containers (NodeSettings, LibrarySettings, FrameworkSettings), resolution chain (OVERRIDE > local > global SET > default), SettingsHolder, TOML tiers
...
4. `docs/documentation/settings.md/05-reference.md` — complete API: `Color`/`Icon` type aliases, all descriptor constructor params, `SettingsRegistry` methods, `SettingsHolder` methods, `SettingInfo` fields, resolution algorithm
