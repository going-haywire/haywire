...
@library_settings(namespace='debug', label='Debug')
class DebugSettings(GlobalSettings):
    ...
    show_data_flow:            bool = setting(False, label='Show Data Flow',            description='Visualise data flowing through connections',     category='debug', order=32)
