...
`haybale-studio:farmhand:list_components` · kind: farmhand
...
kind: one of adapter, editor, farmhand, macro, node, panel, setting, skin, state, theme, type, widget
