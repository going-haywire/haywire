# haybale-testing — component index (v0.2.3)
...
- `haybale-testing:node:EmptyFoldNode` — Empty Fold — Tests that a fold holding no ports raises  _tags: testing, fold_
- `haybale-testing:node:FoldProbeNode` — Fold Probe — Tests fold minting, lanes and open state  _tags: testing, fold, render_
