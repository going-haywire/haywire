...
`haybale-graph-editor:farmhand:set_property` · kind: farmhand

Set a node property (port value or settings field) by name. Undo-recorded.
...
- **input_schema**: `{'type': 'object', 'properties': {'binding_id': {'type': 'string'}, 'node_id': {'type': 'string'}, 'name': {'type': 'string'}, 'value': {'anyOf': [{'type': 'string'}, {'type': 'number'}, {'type': 'integer'}, {'type': 'boolean'}, {'type': 'object'}, {'type': 'array'}, {'type': 'null'}], 'default': None}}, 'required': ['binding_id', 'node_id', 'name']}`
