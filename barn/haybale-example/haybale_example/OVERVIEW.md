...
## Nodes
### Examples
- **Custom Callback** — Listens for custom callbacks from other flows
- **Emit Callback** — Emits a callback to trigger event nodes in other flows
- **Fill Demo** — 
- **Math Operation** — 
...
## Widgets
- **FillWidget** — Background fill editor (solid / linear / radial)
