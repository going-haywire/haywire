...
**Spec reference:** [`internals/specs/marketstall-distribution.md`](../specs/marketstall-distribution.md) §7.4 (first-install safety modal). Inquisition Q9 + Q10a (blocked-list semantics; hide blocked from AVAILABLE; per-source blocking).
